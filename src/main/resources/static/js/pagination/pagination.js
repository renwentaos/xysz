var Pagination = {
    showPageCount: 7, init: function (obj, callback, topFlag) {
        ...
        if (pageIndex > 0) {
            html.push("<span class=\"previous\"><a href=\"javascript:void(0);\" page= " + (pageIndex - 1) + " data-rec=\"上一页\">&lt;</a></span>");
        } else {
        ...
        if (pageCount <= showPageCount) {
            for (var i = 0; i < pageCount; i++) {
                if (pageIndex == i) {
                    ...
                    html.push("<span class=\"num\"><a href=\"javascript:void(0);\"  page=" + i + ">" + (i + 1) + "</a></span>");
                }
            }
            ...
            html.push("<span class=\"num\"><a href=\"javascript:void(0);\"  page=" + (pageCount - 1) + ">" + pageCount + "</a></span>");
        } else if (pageIndex >= pageCount - HalfPageCount - 1) {
            html.push("<span class=\"num\"><a href=\"javascript:void(0);\" page='0'>" + 1 + "</a></span>");
            html.push("<span class=\"dots\">...</span>");
        ...
        if (pageIndex < pageCount - 1) {
            html.push("<span class=\"next\"><a href=\"javascript:void(0);\" page=" + (pageIndex + 1) + " data-rec=\"下一页\">&gt;</a></span>");
        } else {
